...
const Ai = () => {
  ...
  return (
    ...
    {similarImages.length > 0 && (
        ...
        <div className="nav">
          ...
          <div className="box box2">
            ...
            <ul>
              {data.map((i) => (
                <li key={i.id}>
                  <input type="checkbox" id={i.product_category_route} checked={i.product_category_route === selectedCategory} disabled />
                  <label htmlFor={i.product_category_route}>{i.product_category}</label>
                </li>
              ))}
            </ul>
          </div>
          <div className="box box2">
            ...
            <ul>
              {['S', 'M', 'L', 'XL'].map((size) => (
                <li key={size}>
                  <input type="checkbox" id={size} checked={selectedSizes.includes(size)} onChange={() => handleSizeSelection(size)} />
      ...
      {/* FILTER DRAWER */}
      <Drawer open={filOpen} onClose={clsfilter} direction='bottom' className='fil-drawer' size={'100%'}>
      ...
      {/* SORTING DRAWER */}
      <Drawer open={shortproOpen} onClose={closeshortpro} direction='bottom' className='shortpro' size={'100%'}>
        <div className='shortnames'>
